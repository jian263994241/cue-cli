 ...
 * @name setProjectRoot
 */
exports.setProjectRoot = function(srcPath) {
  if (fis.util.isDir(srcPath)) {
    PROJECT_ROOT = fis.util.realpath(path.resolve(process.cwd(), srcPath));
  } else {
